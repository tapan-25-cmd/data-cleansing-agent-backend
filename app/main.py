...
from app.api import chat, evaluations, export, jobs, quality, review, open_questions, rules, reasoning, accuracy, blind_test
...
async def lifespan(app: FastAPI):
    ...
    app.state.agent_evaluation = AgentEvaluationService(
